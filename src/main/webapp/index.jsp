...
<body>
	...
	<form name="login form" id="form-1" action="/login" method="post">
		<div class="jumbotron text-center">
			<img src="image/logo_mimos-1.png" class="img-responsive"
				alt="mimos_logo" align="middle" width="50%" height="auto">
			<!-- 16:9 aspect ratio -->
			<!-- 
			<div class="embed-responsive embed-responsive-16by9">
				<iframe class="embed-responsive-item" src="image/logo_mimos-1.png"
					width="50%" height="auto"></iframe>
			</div>
			<h1>Mi.Mo.S</h1>
