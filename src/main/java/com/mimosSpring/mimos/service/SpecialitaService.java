...
@Service
public class SpecialitaService {
	...
	@Autowired
	public SpecialitaService(SpecialitaRepository specialitaRepository) {
		this.utenteRepository = null;
		this.specialitaRepository = specialitaRepository;
	}
	

	public SpecialitaService(UtenteRepository utenteRepository, SpecialitaRepository specialitaRepository) {
	...
	public long countAll() {
		return this.specialitaRepository.count();
	}

	public SpecialitaEntity save(SpecialitaEntity specialitaEntity) {
		return this.specialitaRepository.save(specialitaEntity);
	}

	public void delete(SpecialitaEntity specialitaEntity) {
		this.specialitaRepository.delete(specialitaEntity);
	}

	public int deleteByIdSpecialita(int idSpecialita) {
		return this.specialitaRepository.deleteByIdSpecialita(idSpecialita);
	}

	public int deleteByNomeSpecialita(String nomeSpecialita) {
		return this.specialitaRepository.deleteByNomeSpecialita(nomeSpecialita);
	}

	public List<SpecialitaEntity> findAll() {
		return this.specialitaRepository.findAll();
	}	

	public SpecialitaEntity findByIdSpecialita(int idSpecialita) {
		return this.specialitaRepository.findByIdSpecialita(idSpecialita);
	}

	public SpecialitaEntity findByUsername(String nomeSpecialita) {
		return this.specialitaRepository.findByNomeSpecialita(nomeSpecialita);
	}

	public int findIdSpecialitaByNomeSpecialita(String nomeSpecialita) {
		return this.specialitaRepository.findIdSpecialitaByNomeSpecialita(nomeSpecialita);
	}

	public String findDescrizioneSpecialitaByIdSpecialita(int idSpecialita) {
		return this.specialitaRepository.findDescrizioneSpecialitaByIdSpecialita(idSpecialita);
	}

	public String findNomeSpecialitaByIdSpecialita(int idSpecialita) {
		return this.specialitaRepository.findNomeSpecialitaByIdSpecialita(idSpecialita);
	}
	
	public boolean addDottoreToSpecialita(int idSpecialita, int idUtente) {
		if (this.specialitaRepository != null) {
			try {
				...
				tSpecialita.getUtente().add(tUtente);
				session.save(tSpecialita);
				transaction.commit();
				return true;
			} catch (Exception e) {
	...
	public boolean removeDottoreToSpecialita(int idSpecialita, int idUtente) {
		if (this.specialitaRepository != null) {
			try {
				transaction = session.beginTransaction();
				...
				UtenteEntity tUtente = (UtenteEntity) session.get(UtenteEntity.class, idUtente);
				SpecialitaEntity tSpecialita = (SpecialitaEntity) session.get(SpecialitaEntity.class, idSpecialita);
				tSpecialita.getUtente().remove(tUtente);
				session.save(tSpecialita);
				transaction.commit();
				return true;
			} catch (Exception e) {
	...
	public Set<UtenteEntity> getSpecialitaWithDottores(int idSpecialita) throws RuntimeException {
		/*
		 * try {
		...
		if (this.specialitaRepository != null) {
			try {
				...
				transaction.begin();
				SpecialitaEntity tSpecialita = (SpecialitaEntity) session.get(SpecialitaEntity.class, idSpecialita);
				Set<UtenteEntity> tmp = tSpecialita.getUtente();
				session.save(tSpecialita);
				transaction.commit();
				return tmp;
			} catch (Exception e) {
